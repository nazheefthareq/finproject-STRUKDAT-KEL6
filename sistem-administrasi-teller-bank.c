...
DoubleNode* initStaticDoubleLinkedList() {
    ...
    int staticData[5] = {101, 102, 103, 104, 105};
    char* staticNames[5] = {"Adam", "Beni", "Christy", "Diana", "Eva"};
...
Node* pop(Stack* stack) {
    ...
    temp->next = NULL;
    printf("Nasabah dengan ID %d dengan nama %s dihapus dari riwayat pelayanan hari ini.\n", temp->id, temp->nama);
    free(temp);
    return temp;
}
...
int main() {
    ...
    do {
        ...
        printf("5. Hapus riwayat pelayanan (Hari ini)\n");
        printf("6. Keluar\n");
